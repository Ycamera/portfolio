...
const neocosmo = {
  ...
  text: "知人が立ち上げた障害福祉事業の企業サイトを請負制作しました。 要件定義、デザイン制作、WordPressテーマ制作・実装、サーバー契約、ドメインの取得などウェブ制作に関わる全ての工程を担当。 事業のターゲットとなる「障害を抱えている方々」がコンテンツを理解しやすいように、トップページからお問い合わせページまでの導線をシンプルに設計し、情報が伝わりやすいように工夫しました。",
