...
const Form = ({ label, placeholder, textarea = false, register, errors, id, nextId, value }) => {
	...
	return (
		<FormControl mb="1rem">
			<FormLabel {...textStyle}>
				{label}
				<Text display="inline-block" color="red.200">
					*
				</Text>
			</FormLabel>
			{!textarea ? (
...
const contact = () => {
	...
	return (
		...
		>
			<TransitionEffect />
			<Flex w="100%" h="100%" mt="7rem" justifyContent={"center"} alignItems="center" flexDirection="column">
				<Motion
					initial={{ y: "5rem", opacity: 0 }}
					animate={{ y: 0, opacity: 1 }}
					transition={{ duration: 1, ease: [0.54, 0.23, 0.26, 0.98] }}
				>
